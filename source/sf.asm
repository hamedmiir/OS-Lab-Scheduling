...
int main(int argc, char const *argv[])
{
  ...
  11:	e8 4c 03 00 00       	call   362 <getpid>
  16:	83 ec 08             	sub    $0x8,%esp
  19:	50                   	push   %eax
  1a:	6a 32                	push   $0x32
  1c:	e8 81 03 00 00       	call   3a2 <set_lottery_ticket>
    createBoundingProcess();
  21:	e8 0a 00 00 00       	call   30 <createBoundingProcess>
    exit();
  26:	e8 b7 02 00 00       	call   2e2 <exit>
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
...
void createBoundingProcess() {
  ...
  34:	83 ec 04             	sub    $0x4,%esp
    int pid = fork();
  37:	e8 9e 02 00 00       	call   2da <fork>
  ...
  58:	e8 15 03 00 00       	call   372 <sleep>
        for(i = 0 ; i < 900000 ; i++)
  ...
  6d:	c9                   	leave  
        wait();
  6e:	e9 77 02 00 00       	jmp    2ea <wait>
        printf(2, "fork error\n");
  73:	83 ec 08             	sub    $0x8,%esp
  76:	68 b8 07 00 00       	push   $0x7b8
  7b:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb c4 07 00 00       	mov    $0x7c4,%ebx
        while(*s != 0){
