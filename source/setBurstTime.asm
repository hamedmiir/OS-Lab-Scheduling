  ...
  10:	8d 9d e8 fb ff ff    	lea    -0x418(%ebp),%ebx
{
  ...
  38:	53                   	push   %ebx
  39:	6a 01                	push   $0x1
  3b:	e8 aa 02 00 00       	call   2ea <read>
    pid = atoi(buf);
  ...
  60:	53                   	push   %ebx
  61:	6a 01                	push   $0x1
  63:	e8 82 02 00 00       	call   2ea <read>
    burst_time = atoi(buf);
  ...
  72:	56                   	push   %esi
  73:	50                   	push   %eax
  74:	e8 09 03 00 00       	call   382 <set_burst_time>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb c9 07 00 00       	mov    $0x7c9,%ebx
        while(*s != 0){
 ...
 621:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 7c 0a 00 00    	cmp    %eax,0xa7c
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
 ...
 777:	0a 00 00 
 77a:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 80 0a 00 00       	mov    $0xa80,%eax
 789:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 790:	00 00 00 
